...
class add_initRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type add_initRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type add_initRequest
    let len;
    let data = new add_initRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new add_initRequest(null);
...
class add_initResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type add_initResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type add_initResponse
    let len;
    let data = new add_initResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'plumbing_server_client/add_initResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new add_initResponse(null);
...
module.exports = {
  Request: add_initRequest,
  Response: add_initResponse,
  md5sum() { return '4781436a0c2affec8025955a6041e481'; },
  datatype() { return 'plumbing_server_client/add_init'; }
};
