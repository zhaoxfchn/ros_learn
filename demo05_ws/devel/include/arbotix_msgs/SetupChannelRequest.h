...
bool operator==(const ::arbotix_msgs::SetupChannelRequest_<ContainerAllocator1> & lhs, const ::arbotix_msgs::SetupChannelRequest_<ContainerAllocator2> & rhs)
{
...
struct Definition< ::arbotix_msgs::SetupChannelRequest_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# message to setup an IO channel\n"
"string topic_name\n"
"uint8 pin\n"
"uint8 value\n"
"uint8 rate\n"
